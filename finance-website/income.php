...
<section class="dashboard-header">
    <div class="container-fluid">
        <div class="row align-items-center">
            <div class="col-lg-8">
                <h1 class="dashboard-title">Income</h1>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-lg-3 col-md-6 mb-3">
                        <div class="stat-card">
                            ...
                            <div class="stat-content">
                                <h3 class="stat-value">RWF 450,000</h3>
                            ...
                            <div class="chart-body">
                                <div class="income-sources">
                                    <div class="source-item">
                                        <span class="source-label">Client Services</span>
                                        <span class="source-value">45%</span>
                                    </div>
                                    <div class="source-item">
                                        <span class="source-label">Consulting</span>
                                        <span class="source-value">30%</span>
                                    </div>
                                    <div class="source-item">
                                        <span class="source-label">Investments</span>
                    ...
                    <div class="col-12">
                        <div class="dashboard-card">
                            <div class="card-header">
                                <h5>Recent Income Transactions</h5>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>2024-01-12</td>
                                                <td>Service Contract - DEF Inc</td>
                                                <td>Client Services</td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Enter income description">
                    </div>
                    <div class="mb-3">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success">Record Income</button>
            </div>
        </div>
    </div>
</div>
